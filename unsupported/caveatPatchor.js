SOUND_HATERS = ["TPW", "Tekkub", "josh", "Melissa", "rodjek", "bleikamp", "justin", "tclem", "jakeboxer", "aroben", "cameronmcefee", "blackant", "VxJasonxV", "Danny", "jbarnette", "ymendel", "pjhyett", "paul", "erebor", "jnewland", "jonrohan"]
IFRAME_HATERS = ["Tekkub", "probablycorey", "sr", "Petros", "pjhyett", "bryanveloso", "jakeboxer", "cameronmcefee", "VxJasonxV", "skalnik", "jbarnette", "paul", "josh", "jonrohan"]
EMOJI_HATERS = ["TPW", "Melissa", "Tim", "bleikamp", "justin", "tclem"]
HATERS = ["kneath", "defunkt", "rtomayko", "josh", "atmos"]
AUSSIES = ["rodjek", "cobyism", "ekb", "barrbrain"]
